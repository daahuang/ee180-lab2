...
pthread_barrier_t endImgLoad;
pthread_barrier_t endGray;
...
int mainMultiThread()
{
  ...
  pthread_barrier_init(&endGray, NULL, 2);
  pthread_barrier_init(&endImgLoad, NULL, 2);
  ...
  pthread_barrier_destroy(&endImgLoad);
  pthread_barrier_destroy(&endGray);
